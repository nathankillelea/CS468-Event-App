...
class StoreDetail extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      pointsCost: props.route.params.pointsCost,
  ...
  redeemHelper() {
    if (this.props.userPoints >= this.state.pointsCost) {
      ...
      this.props.redeemFromStore(this.state.index);
    }
  }
...
const mapDispatchToProps = (dispatch) => {
  return {
    redeemFromStore: (index) => {dispatch(redeem_from_store(index));},
  };
};
